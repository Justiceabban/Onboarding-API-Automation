...
Adding a New Client
Create new client class in client/ package
Extend with methods following the pattern:
...
Adding New Models
Create POJO in models/request/ or models/response/
Add Jackson annotations
Implement builder pattern (optional but recommended)
Adding New Tests
Create test class in appropriate tests/ subdirectory
...
📝 Maintenance
Regular Tasks:
Update dependencies in pom.xml quarterly
Review and update bearer tokens as they expire
Add new endpoints as API evolves
